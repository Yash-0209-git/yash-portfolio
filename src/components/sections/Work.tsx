...
const FALLBACK_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    technologies: ['Python', 'FastAPI', 'FAISS', 'Sentence Transformers', 'Groq API', 'Llama 3.3 70B', 'React 18', 'TypeScript', 'Web Speech API', 'Tailwind CSS', 'PyTorch'],
    featured: true, published: true, display_order: 2,
    thumbnail_url: '/projects/rag-tech-bot.png',
    problem: 'Standard LLMs produce hallucinations or lack specific context when answering specialized technical and network troubleshooting queries.',
  ...
  },
  {
    ...
    technologies: ['React 18', 'TypeScript', 'Three.js', 'React Three Fiber', 'FastAPI', 'Python', 'Groq API', 'Llama 3', 'Tailwind CSS', 'Vite'],
    featured: true, published: true, display_order: 4,
    thumbnail_url: '/projects/neuro-ai.png',
    problem: 'Beginners and students struggle to navigate complex open-source codebases, translate code across programming languages with architectural context, configure API keys, and discover active developer internships across fragmented portals.',
    solution: 'Engineered NEURO — a volumetric 3D dual-hemisphere neural brain workspace featuring interactive 3D node network visualizers, Groq AI GitHub repository evaluation, Rosetta Stone multi-language syntax translation with laser Bezier signals, and a 20-platform Career Synapse internship scraper.',
    challenges: 'Optimizing Three.js / React Three Fiber GPU particle performance for real-time 3D neural brain mesh deformation, decoding Base64 tracking redirects on the fly for direct internship links, and structuring low-latency Groq Llama-3 response streaming.',
  },
];
