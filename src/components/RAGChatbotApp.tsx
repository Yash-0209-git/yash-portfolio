...
const KNOWLEDGE_BASE = [
  {
    ...
    answer: 'Yashwanth has engineered standout full-stack AI applications:\n\n1. 🧠 **Neuro AI** (2026) — Cinematic 3D Synaptic Discovery Engine & Developer Brain Workspace featuring Three.js 3D volumetric neural mesh, Groq Llama-3 repository evaluation, Rosetta Stone multi-language code translator, and a 20-platform Career Synapse internship locator.\n2. 🚗 **AutoTrack** (2026) — Full-stack Vehicle Service & Workshop Management System with real-time job status tracking, customer records, Supabase persistence, and automated PDF invoicing.\n3. 🏋️ **LeeSculpt Gym Application** (2026) — AI-powered Gym Management System with personalized fitness tracking, automated diet guidance via Groq & Gemini API, and WhatsApp notifications.\n4. 🔮 **CodeSage AI** (2026) — Intelligent Codebase Analysis & RAG Debugging Platform that extracts repository .zip files, detects project architecture, flags bugs & security issues, and provides an interactive Deep AI RAG assistant.\n5. 🤖 **RAG-Tech Assistant** (2025) — Technical QA Chatbot featuring query expansion, FAISS vector retrieval, reranking, and Llama 3.3 70B generation.',
    sources: ['PROJECT_INDEX.DB', 'STATIC_PROJECTS.TS'],
  },
  {
    keywords: ['neuro', 'neuro-ai', 'brain', 'synaptic', 'three.js', '3d', 'rosetta', 'internship', 'scrapper'],
    answer: '🧠 **Neuro AI (2026)**:\n- **Problem**: Beginners and students struggle to navigate complex open-source repositories, translate code across languages with architectural context, find API keys, and discover active developer internships.\n- **Solution**: A volumetric 3D dual-hemisphere neural brain workspace with interactive 3D node network visualizers, Groq Llama-3 GitHub repo evaluation, Rosetta Stone multi-language code translator with laser signals, and a 20-platform Career Synapse internship scraper.\n- **Tech Stack**: React 18, TypeScript, Three.js, React Three Fiber, FastAPI, Python, Groq API, Llama 3, Tailwind CSS, Vite.',
    sources: ['NEURO_3D_ENGINE.TSX', 'CAREER_SYNAPSE_SCRAPER.PY'],
  },
  {
