...
- **YashOS v1.0 Mini Windows OS Desktop**: Secret Easter Egg OS environment unlocked via secret code sequence (`↑ ↑ ↓ ↓ ← → ← → B A`), complete with `This PC`, `File Manager`, `Flappy Bird.exe`, `About Me.txt`, `GitHub`, `LinkedIn`, `Instagram`, and `Gmail`.
